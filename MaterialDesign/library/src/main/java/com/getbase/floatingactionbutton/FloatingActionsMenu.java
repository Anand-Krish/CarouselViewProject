...
public class FloatingActionsMenu extends ViewGroup {
    ...
    private ArrayList<FloatingActionsMenu> FABMenuList = new ArrayList<>();
    ...
    private void createAddButton(Context context) {
        ...
        mAddButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (FABMenuList.size() > 0) {
                    for (FloatingActionsMenu FABMenu :
                            FABMenuList) {
                       // int i= FABMenuList.indexOf(FABMenuList);
                       // if(i!=0)
                       // {
                            FABMenu.getFABButton().performClick();
                       // }
    ...
    public void addFABMenu(FloatingActionsMenu FABMenu) {
        FABMenuList.add(FABMenu);
    }
